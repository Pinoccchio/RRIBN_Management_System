  ...
  try {
    ...
    const reservists: Reservist[] = (data || []).map((res: ReservistViewData) => ({
      ...
      reservist_details: {
        ...
        commission_authority: res.commission_authority,
        mobilization_center: res.mobilization_center,
        designation: res.designation,
        squad_team_section: res.squad_team_section,
        platoon: res.platoon,
        battalion_brigade: res.battalion_brigade,
        combat_shoes_size: res.combat_shoes_size,
        cap_size: res.cap_size,
        bda_size: res.bda_size,
        created_at: res.created_at,
        updated_at: res.updated_at,
      },
