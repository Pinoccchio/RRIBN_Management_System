...
export default function TrainingReportPage() {
  ...
  const fetchTrainingData = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/staff/reports/training-summary');
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Training sessions attendance and completion statistics"
        breadcrumbs={[
      ...
      <div className="mb-6 flex justify-between items-center">
        ...
        <ExportPDFButton
          reportTitle="Training Summary Report"
          reportSubtitle="Attendance and completion statistics"
          company={companies.join(', ')}
          columns={pdfColumns}
          data={data}
          filename={generateFileName('Training_Summary', companies.join('_'))}
      ...
      <ReportTable
        ...
        data={data}
        loading={loading}
        emptyMessage="No training sessions found for your assigned companies"
      />
    </div>
  );
}
