...
export default function DocumentsReportPage() {
  ...
  const fetchDocumentsData = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/staff/reports/pending-documents');
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Documents awaiting validation from your assigned companies"
        breadcrumbs={[
      ...
      <div className="mb-6 flex justify-between items-center">
        ...
        <ExportPDFButton
          ...
          reportSubtitle="Documents awaiting validation"
          company={companies.join(', ')}
          columns={pdfColumns}
          data={data}
          filename={generateFileName('Pending_Documents', companies.join('_'))}
      ...
      <ReportTable
        ...
        data={data}
        loading={loading}
        emptyMessage="No pending documents found in your assigned companies"
      />
    </div>
  );
}
