...
import { ArrowLeft, Mail, Phone, Shield, Calendar, CheckCircle } from 'lucide-react';
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div className="bg-navy-900 px-8 py-6">
          <div className="flex items-center gap-6">
            <Avatar
              firstName={profile?.first_name || 'Super'}
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <span className="text-yellow-500 font-semibold">Super Administrator</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="px-4 py-3 bg-gray-50 rounded-lg border border-gray-200 flex items-center gap-3">
                ...
                <p className="text-navy-900 font-medium">Super Administrator</p>
              </div>
            </div>
